---
title: The world will end with sound design 
categories: ["Music"] 
...
If the other tracks look inside the computer, this one looks at the wall above it. Hanging there is a framed picture with the frontispiece of Tchaikovsky's [Symphony No. 6, 'Pathétique'](https://en.wikipedia.org/wiki/Symphony_No._6_(Tchaikovsky)). It is a constant reminder of his greatness which, as I wrote in the SoundCloud description, 'reminds me that I am nobody'.   
Technically, this track is an exercise in desktop [musique concrète](https://en.wikipedia.org/wiki/Musique_concr%C3%A8te): I completely banned synthesis. Every rhythm and texture you hear comes from the manipulation of physical objects I had at hand: pens, metal balls, office junk.   
...
The melody, for example, is generated via [spectral synthesis](https://en.wikipedia.org/wiki/Spectral_modeling_synthesis): I used the spectrogram of a segment of the recording as a 'map' to generate the sound.   
For the final brass, I utilized [wavetable synthesis](https://en.wikipedia.org/wiki/Wavetable_synthesis): the water sample was transformed into a cyclic waveform, allowing me to play the 'movement' of the liquid as if it were a powerful synthesizer.   
## Leck mir den Arsch   
The title, quoting Mozart's famous canon (and the celebrated scurrilous letters) to his cousin, is already a clue to the irreverent approach of this track. The raw material is untouchable: a recording of the ["Catalog Aria"](https://youtu.be/INF9r5jju0A?si=ad5Ou7R-aIEDKoxO) (Madamina, il catalogo è questo) from [Don Giovanni](https://en.wikipedia.org/wiki/Don_Giovanni).   
